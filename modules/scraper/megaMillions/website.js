...
module.exports.scrape = () => {
  nightmare
    ...
    .evaluate(() => {
      ...
      obj.nextDrawDate = document.querySelector('span.nextDrawDate').innerText + '/' + new Date().getFullYear()
      // If no big winners assign null to match_type and states
      try {
        ...
        obj.lastDrawing.big_winners = { match_type: null, states: null }
      }
      return obj
    })
    .then(obj => {
